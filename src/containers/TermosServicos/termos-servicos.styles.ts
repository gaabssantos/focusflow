...
export const TermsToc = styled.div`
...
export const TermsSectionContent = styled.div`
  margin-bottom: 40px;
`;
...
export const TermsHighlight = styled.div`
  background-color: rgba(99, 102, 241, 0.05);
...
export const TermsHighlightTitle = styled.div`
  font-weight: 600;
  font-size: 18px;
  margin-bottom: 10px;
  color: var(--dark, #1e293b);
